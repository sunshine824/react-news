            ...
            <div>
                <Row>
                    ...
                    <Col span={20} className="container">
                        ...
                        <PCNewsImageBlock count={12} type="edu" width="100%" cartTitle="教育新闻" imageWidth="112px" page={1}/>
                        <PCNewsImageBlock count={12} type="tech" width="100%" cartTitle="科技新闻" imageWidth="112px" page={1}/>
                    </Col>
                    <Col span={2}></Col>
                </Row>
            </div>
